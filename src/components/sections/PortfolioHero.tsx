        ...
        >
          ...
          >
            {portfolioIcons.map((IconComponent, index) => (
              ...
              >
                <div className="w-16 h-16 bg-gradient-to-br from-green-100 to-blue-100 rounded-2xl flex items-center justify-center shadow-lg">
                  <IconComponent size={32} className="text-green-600" />
                </div>
                <span className="text-sm text-gray-600 font-medium">Category {index + 1}</span>
              </motion.div>
            ))}
          </motion.div>
        </motion.div>
