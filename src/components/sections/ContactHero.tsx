...
const contactIcons = [Mail, Phone, MapPin, MessageSquare];
...
export default function ContactHero() {
  ...
  useEffect(() => {
    ...
    const createFloatingIcons = () => {
      ...
      contactIcons.forEach((IconComponent, index) => {
        // Create icon geometry based on type
        let geometry: THREE.BufferGeometry;
        let material: THREE.Material;
        
        switch (index) {
          case 0: // Mail - Envelope
            geometry = new THREE.BoxGeometry(0.6, 0.4, 0.1);
    ...
    <section ref={containerRef} className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center" style={{ zIndex: 3 }}>
        ...
        >
          ...
          >
            {contactIcons.map((IconComponent, index) => (
              <motion.div
                key={index}
